...
const Sidebar = () => {
  const {getUsers,users,selectUser,isUserLoading, setSelectedUser}=useChatStore()
  ...
  return (
    <aside className="h-full w-20 lg:w-72 border-r border-base-300 transition-all flex flex-col duration-200">
      <div className="border-b border-base-300 w-full p-5">
        ...
        <div className="mt-3 hidden lg:flex items-center gap-2">
          <label className="cursor-pointer flex flex-items gap-2">
            <input 
            type="checkbox" 
